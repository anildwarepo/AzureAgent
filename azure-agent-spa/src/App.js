...
function Bubble({ role, text, reportId }) {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/chat`, {
        ...
        body: JSON.stringify({ message: msg, subscription_id: selectedSub || null }),
      });
    ...
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-section sidebar-questions">
          <label className="sidebar-label">Quick Questions</label>
        ...
        {view === "chat" && (
          <div className="chat-container">
            ...
            <div className="chat-messages">
              ...
              {messages.map((m, i) => (
                <Bubble key={i} role={m.role} text={m.text} reportId={m.reportId} />
              ))}
