"""
Azure Operations Agent - SSE Event Bus

Session-based async queue for streaming Server-Sent Events (SSE) from
the agent back to the UI. Each user session gets its own queue.
"""
